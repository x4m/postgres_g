 ...
 *
 * IDENTIFICATION
 *	  contrib/amcheck_flashback/verify_nbtree.c
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
 ...
 *
 * Note that this is the only place where amcheck_flashback will "couple" buffer locks
 ...
 * are forms of corruption that amcheck_flashback could theoretically fail to report.
 *
 ...
 * might otherwise cause amcheck_flashback to assume (rather than actually verify) that
