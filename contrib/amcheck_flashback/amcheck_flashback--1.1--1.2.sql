/* contrib/amcheck_flashback/amcheck_flashback--1.1--1.2.sql */

-- complain if script is sourced in psql, rather than via CREATE EXTENSION
\echo Use "ALTER EXTENSION amcheck_flashback UPDATE TO '1.2'" to load this file. \quit

-- In order to avoid issues with dependencies when updating amcheck_flashback to 1.2,
