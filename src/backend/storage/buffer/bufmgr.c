...
retry:
	...
	/*
	 * Keep the header locked until its fixed entry slot has been removed.
	 * Otherwise a concurrent GetVictimBuffer() could reuse the same slot
	 * before BufTableDelete() examines it.
	 */
