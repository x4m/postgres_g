...
// bool
// PageIndexTupleMultiOverwrite(Page page, OffsetNumber offnum, int removecount, int addcount,
// 						Item *newtups, Size *newsizes)
// {
// 	PageHeader	phdr = (PageHeader) page;
// 	ItemId		tupid;
// 	int			oldsize;
...
// 	itemcount = PageGetMaxOffsetNumber(page);
// 	if ((int) offnum <= 0 || (int) offnum >= itemcount - removecount)
// 		elog(ERROR, "invalid index offnum: %u", offnum);
