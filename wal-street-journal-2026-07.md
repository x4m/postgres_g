...
**Медианный ревьюер июля прочитал ровно один патч.** Хвост длинный: 98 человек
на 332 трейлера. Именно этот хвост, а не два десятка коммиттеров, определяет,
сколько патчей проект способен принять за цикл.
