...
% TODO, когда освободится машина:
% 1. Накладные расходы: время и число прочитанных страниц относительно размера
%    индекса, холодный и тёплый кэш. Первичная величина — страницы.
% 2. Расход памяти при обходе по уровням против обхода сверху вниз — прямая
%    проверка утверждения §\ref{sec:parent}.
% 3. Проверка на реплике против основной системы: влияние на задержку
%    пользовательской нагрузки.
% 4. Ключ родителя — после разбора формата кортежа внутренней страницы словаря.
